...
venue: "Theo Murphy Winter School in Research Data Science"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Room 343, GP South (Building 78), The University of Queensland, St Lucia Campus"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
helper: ["Valentine Murigneux"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["bweaver@carpentries.org"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  "http://pad.software-carpentry.org/wrds"           # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<tr><td valign="top">9:00 - 10:30</td> <td valign="top">Version Control with Git</td></tr>
	...
	<tr><td valign="top">12:30 - 13:30</td> <td valign="top">Lunch</td></tr>
